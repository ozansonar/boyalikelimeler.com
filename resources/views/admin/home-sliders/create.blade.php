...
@section('title', 'Yeni Slide — Admin')
...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb breadcrumb-reset fs-13">
            ...
            <li class="breadcrumb-item active text-teal">Yeni Slide</li>
        </ol>
    </nav>
    ...
    <div class="page-header d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4" data-aos="fade-down">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h1 class="page-title">Yeni Slide Oluştur</h1>
                <p class="page-subtitle">Ana sayfa slider'ına yeni bir öğe ekleyin</p>
            </div>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.home-sliders.store') }}">
        @csrf
