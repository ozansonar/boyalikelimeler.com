...
@section('title', 'Yeni Edebiyat Kategorisi — Admin')
...
@section('content')
    ...
    <div class="page-header d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4" data-aos="fade-down">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h1 class="page-title">Yeni Edebiyat Kategorisi</h1>
                <p class="page-subtitle">Edebiyat eserleri için yeni bir kategori ekleyin</p>
            </div>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.literary-categories.store') }}">
        @csrf
