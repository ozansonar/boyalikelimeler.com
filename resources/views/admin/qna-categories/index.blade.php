                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="usr-actions">
                                        ...
                                        <button class="usr-action-btn danger" title="Sil" onclick="openDeleteModal({{ $category->id }}, '{{ addslashes($category->name) }}', '{{ route('admin.qna.categories.destroy', $category->id) }}')">
