...
@section('title', 'Yeni Reklam — Admin')
...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb breadcrumb-reset fs-13">
            ...
            <li class="breadcrumb-item active text-teal">Yeni Reklam</li>
        </ol>
    </nav>
    ...
    <div class="page-header d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4" data-aos="fade-down">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h1 class="page-title">Yeni Reklam Oluştur</h1>
                <p class="page-subtitle">Ana sayfada gösterilecek yeni bir reklam ekleyin</p>
            </div>
        </div>
    </div>
