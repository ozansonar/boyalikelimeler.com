...
@section('title', $category->name . ' — Boyalı Kelimeler')
@section('meta_description', $category->description ?: $category->name . ' kategorisindeki blog yazıları.')
@section('canonical', route('category.show', $category->slug))
@section('og_title', $category->name . ' — Boyalı Kelimeler')
@section('og_description', $category->description ?: $category->name . ' kategorisindeki blog yazıları.')

@section('content')

    <!-- Page Header -->
    <section class="blog-page-header" aria-label="Kategori sayfa başlığı">
        <div class="container">
            <!-- Breadcrumb -->
            ...
            <div class="blog-page-header__inner">
                <h1 class="blog-page-header__title">
                    <i class="fa-solid fa-folder-open me-3"></i>{{ $category->name }}
                </h1>
                ...
                <div class="blog-page-header__stats">
                    <span class="blog-page-header__stat">
                        <i class="fa-solid fa-file-lines me-1"></i>{{ $posts->total() }} Yazı
                    </span>
                </div>
            </div>
        </div>
    ...
    <!-- BLOG İÇERİK — Grid + Sidebar -->
    <section class="blog-section" aria-label="Kategori yazıları">
        <div class="container">
            <div class="row g-4">
                    ...
                    <div class="blog-grid">
                        ...
                        @empty
                            <div class="blog-empty text-center py-5">
                                ...
                                <p class="text-muted">Bu kategoride henüz yayınlanmış yazı bulunmuyor.</p>
                            </div>
                        @endforelse
                    </div>
                    ...
                    <div class="blog-sidebar">
                        ...
                        <div class="blog-sidebar__card">
                            ...
                            <ul class="blog-sidebar__cat-list">
                                <li>
                                    <a href="{{ route('blog.index') }}" class="blog-sidebar__cat-link">
